...
<div class="image-row">
  <img src="{{ '/assets/images/PowerCurves.jpg' | relative_url }}" class="img-small" alt="Power curves">
  <img src="{{ '/assets/images/TestingAction.jpg' | relative_url }}" class="img-large" alt="Wind tunnel testing">
</div>
